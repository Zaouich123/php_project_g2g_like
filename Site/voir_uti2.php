...
if(!isset($_SESSION['id_uti'])){
    // Si pas connecté, revoie vers l'accueil
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      ?>
      <td><a href="annonce_modif.php?id=<?=$annPro['id_offre'] ?>" class="btn btn-primary">Modifier l'annonce</a>
